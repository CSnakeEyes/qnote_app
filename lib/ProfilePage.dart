                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Stack(fit: StackFit.loose, children: <Widget>[
                        ...
                        Padding(
                            padding: EdgeInsets.only(top: 120.0, right: 120.0),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: <Widget>[
                                CircleAvatar(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Column(
                                ...
                                children: <Widget>[
                                  setProfileHeadingText("Personal Information")
                                ],
                              ),
                              Column(
